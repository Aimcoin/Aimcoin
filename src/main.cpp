...
int64 nChainStartTime = 1400190961; // AIMCOIN IS
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "We love AUID R8 2014";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print(); */
	assert(block.hashMerkleRoot == uint256("0x724139bc053bcfd3b2c44a14d28ac1c4a5f339bf9c70a83ec9f3c55ca866650c"));
